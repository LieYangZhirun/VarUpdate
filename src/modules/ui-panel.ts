...
const HELP: Record<string, { title: string; content: string; wide?: boolean; large?: boolean }> = {
  ...
  <div style="flex: 1;">
    ...
    <table style="width: 100%; border-collapse: collapse; margin-top: 2px; font-size: 0.85em; text-align: left;">
      ...
      <tr style="border-bottom: 1px solid var(--SmartThemeBorderColor, #ccc);"><td style="padding: 4px;"><code>#</code></td><td style="padding: 4px;">计算数组or字典长度后再进行比较</td><td style="padding: 4px;"><code>["玩家/物品栏" # &lt; 5]</code></td></tr>
